...
# 读取PLY文件
pcd = o3d.io.read_point_cloud("/data1/zhangweiqi/my_Text2Tex/example.ply")
...
colors = np.zeros([100000, 3])
colors[:, 0]  = 0.5
colors[:, 1]  = 0.5
colors[:, 2]  = 0.5

gaussian = np.zeros([100000, 59])
...
gaussian[:,52:55] = -5.25 # 2.7536449349747157857411097102426e-5
...
convert(gaussian, './point_cloud.ply')
